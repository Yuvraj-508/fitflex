...
<div className="hero relative px-[4%] flex flex-col justify-center items-start text-white h-screen">
  ...
  <div className="relative top-35">
     <div className="flex items-center gap-2 bg-white/10 px-3 py-1 rounded-full w-fit text-sm tracking-wide">
          <Star size={12} stroke="#FFD900" /> FITNESS FOR EVERYONE
        </div>
    <h1 className="text-[64px] mt-3 font-bold my-4 leading-[1.3] max-w-[60%]">
      MORE THAN A GYM - IT'S A LIFESTYLE{" "}
    </h1>
    <p className="text-[20px] mt-8 max-w-sm text-gray-200">
